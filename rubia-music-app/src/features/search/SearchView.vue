...
<template>
  <section class="search-view">
    <header class="topbar"><form class="search-box" @submit.prevent="search"><span>⌕</span><input ref="searchInput" v-model="query" autofocus placeholder="搜索歌曲、艺人或专辑" /><kbd>⌘ F</kbd></form><button class="avatar">R</button></header>
