...
<template>
  <footer class="player-bar">
    ...
    <div class="volume"><button class="queue-button" title="播放队列" @click="queueOpen=!queueOpen">☷</button><span>◖</span><input type="range" min="0" max="1" step="0.01" :value="player.state.volume" @input="player.setVolume(Number(($event.target as HTMLInputElement).value))" /></div>
